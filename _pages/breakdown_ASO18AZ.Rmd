...
par.locs_proj <- sp::spTransform(par.locs,sp::CRS("+init=ESRI:102009"))
Americas_proj <- sp::spTransform(wrld_simpl[wrld_simpl$REGION==19,],sp::CRS("+init=ESRI:102009"))
...
gcLines_map <-do.call("rbind",lapply(gcLines_sp,sp::spTransform,sp::CRS("+init=ESRI:102009")))
...
raster::plot(sp::spTransform(sp::SpatialPoints(tucson,sp::CRS("+init=epsg:4326")),
                             sp::CRS("+init=ESRI:102009")),pch = 19, col = "red",add =TRUE)
```
