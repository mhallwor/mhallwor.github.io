...
```{r}
rgb_vals <- colorRampPalette(c("wheat3","springgreen4"))(3)
```
```{r echo = FALSE}
rgb_vals
```
...
nd <- list.files("../Spatial_Layers")[grep(x=list.files("../Spatial_Layers"),pattern = "ndvi*")]
bd <- list.file("../Spatial_Layers/")[grep(x=list.files("../Spatial_Layers"),pattern = "*.hdf")]
